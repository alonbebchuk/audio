...
if __name__ == '__main__':
    ...
    ctc.plot('Log Alpha Matrix', 'log_alpha_matrix.pdf')
    # Q6
    ctc = CTC(SEQUENCE, ALPHABET_LABELS, PRED, force_align=True)
    ctc.plot('Log Alpha Matrix Force Align', 'log_alpha_matrix_force_align.pdf')
    # Q7
    ...
    ctc = CTC(sequence, alphabet_labels, pred, force_align=True)
    ctc.plot('Log Alpha Matrix Force Align Pickle', 'log_alpha_matrix_force_align_pickle.pdf')
